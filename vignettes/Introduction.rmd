...
Below, we focus on basic usage. In general, the list returned by the original 
functionality contains processing metadata in addition to modified peak table. 
